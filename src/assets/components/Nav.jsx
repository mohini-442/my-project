...
const navsec = () => {
    return (
        <div>
            <div className='bg-header min-vh-100 d-flex flex-column overflow pb-5 bg-blue2 position-relative z-1'>
                ...
                <div className='container flex-grow-1 d-flex justify-content-center flex-column position-relative'>
                    <h1 className='ff-poppins fs-xxl color-white fw-normal max-w-515'>Vitae nunc, <span className='fw-bold'>blandit a odio</span> </h1>
                    <p className='ff-poppins fs-sm color-white op-7 max-w-547 pt-3'>Semper in egestas risus id tempus. Pellentesque dolor eros sollicitudin feugiat ut odio semper. Mattis fermentum eget ut vestibulum dolor diam</p>
