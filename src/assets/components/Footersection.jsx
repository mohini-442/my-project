        ...
        <div>
            <footer class="footer-bg bg-blue2">
                <div class="container pt-5">
                    <p class="ff-poppins fw-semibold fs-xl text-center lh-124 color-white pt-5 mb-0">JOIN US</p>
                    <div class="row pt-5">
                        <div class="col-lg-8 col-12">
                            <p class="ff-poppins  fw-medium fs-2lg lh-124 color-white pt-5 cursor-pointer">LOGO</p>
                            <p class="ff-poppins fw-normal lh-150 color-white fs-xs op-6 max-w-388">Aenean arcu sed rhoncus sapien euismod cursus morbi lacus, blandit.
                                Placerat
                                tortor
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="row pt-5">
                                <div class=" col-6 pt-sm-0 pl-1">
                                    <p class="ff-poppins fw-medium lh-150 color-white fs-xs pt-5 mb-0">Resources</p>
                                    <ul className='ps-0'>
                                        <li className='mt-2'><a href="" class="ff-poppins fw-normal fs-xxs lh-136 color-white links">Roadmap</a></li>
                                ...
                                <div class="col-6 pt-sm-0">
                                    <p class="ff-poppins fw-medium lh-150 color-white fs-xs pt-5 mb-0">Community</p>
